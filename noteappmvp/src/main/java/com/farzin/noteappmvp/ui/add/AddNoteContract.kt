...
class AddNoteContract @Inject constructor(private val repository: AddRepository,private val view: AddNotePresenter.View)
    : BasePresenterImpl() , AddNotePresenter.Presenter{
